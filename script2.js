...
for (let i = 0; i < starWarsCharacters.length; i++) {
  if (starWarsCharacters[i].gender === "female") {
    femaleCharacters[j] = starWarsCharacters[i];
...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    ...
    case "red":
      ...
      break;
    case "blue-gray":
      eyeColor.blue_gray[i] = starWarsCharacters[i];
      break;
...
console.log("la massa é " + crewMass);
...
console.log(
  "c era una volta " +
    starWarsCharacters[numeroRandomico].name +
    " nato il " +
    starWarsCharacters[numeroRandomico].birth_year +
    " e la sua massa era di " +
    starWarsCharacters[numeroRandomico].mass +
    "."
);
